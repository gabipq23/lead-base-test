...
function getActionStyle(record: ILead) {
    return {
        color: "#8c8c8c",
        cursor: record.is_reserved ? "not-allowed" : "pointer",
        opacity: record.is_reserved ? 0.4 : 1,
        flexShrink: 0,
    };
}
export function getStatusColor(status: string): string {
    ...
    if (normalized === "RESERVADO") return "gold";
    if (normalized === "VENDIDO") return "blue";
    return "default";
}

function renderCopyableText(value: string | number | null | undefined, record?: ILead) {
    if (value == null || value === "") {
        return "-";
    }
...
export function getColumns(options: GetColumnsOptions): TableColumnsType<ILead> {
    ...
    return [
            ...
            ? [
                {
                    ...
                    width: 140,
                    render: (reservedAt: string | null, record: ILead) => renderCopyableText(reservedAt, record),
                },
                {
                    ...
                    width: 130,
                    render: (userId: number | null, record: ILead) => renderCopyableText(userId, record),
                },
            ]
            : []),
        {
            ...
            width: 100,
            render: (createdAt: string, record: ILead) => renderCopyableText(createdAt, record),
        },
        {
            key: "elapsed",
            ...
            render: (_, record) => {
                ...
                return (
                    <div className="flex items-center gap-1 min-w-0">
                        ...
                        <Tooltip title="Copiar" overlayInnerStyle={{ fontSize: 12 }}>
                            <CopyOutlined
                                onClick={(e) => handleProtectedCopy(e, full_name, record)}
                                style={getActionStyle(record)}
                            />
                        </Tooltip>
                    </div>
                );
        ...
        },
        {
            ...
            dataIndex: "cpf",
            width: 150,
            render: (cpf: string, record: ILead) => {
                if (!cpf) {
                    return (
                        <span
                            style={{
                ...
                return renderCopyableText(formatCPF(cpf), record);
            },
        }, {
            key: "mother_name",
            title: "Nome da mãe",
            ...
            width: 180,
            ellipsis: true,
            render: (motherName: string, record: ILead) => {
                if (!motherName) {
                    return (
                        <span
                            style={{
                ...
                return renderCopyableText(motherName, record);
            },
        },
        {
            key: "birth_date",
            ...
            width: 140,
            render: (birthDate: string, record: ILead) => {
                if (!birthDate) {
                    return (
                        <span
                            style={{
                ...
                return renderCopyableText(birthDate, record);
            },
        },
        {
            key: "age",
            ...
            render: (phone: string, record) => {
                ...
                return (
                    <div className="flex items-center gap-1 min-w-0">
                        ...
                        <Tooltip title="Copiar" overlayInnerStyle={{ fontSize: 12 }}>
                            <CopyOutlined
                                onClick={(event) => handleProtectedCopy(event, phone, record)}
                                style={getActionStyle(record)}
                            />
                        </Tooltip>
                    </div>
            ...
            render: (additional_phone: string, record) => {
                ...
                return (
                    <div className="flex items-center gap-1 min-w-0">
                        ...
                        <Tooltip title="Copiar" overlayInnerStyle={{ fontSize: 12 }}>
                            <CopyOutlined
                                onClick={(event) => handleProtectedCopy(event, additional_phone, record)}
                                style={getActionStyle(record)}
                            />
                        </Tooltip>
                    </div>
            ...
            render: (email: string, record) => {
                ...
                return (
                    <div className="flex items-center gap-1 min-w-0">
                        ...
                        <Tooltip title="Copiar" overlayInnerStyle={{ fontSize: 12 }}>
                            <CopyOutlined
                                onClick={(event) => handleProtectedCopy(event, email, record)}
                                style={getActionStyle(record)}
                            />
                        </Tooltip>
                    </div>
        ...
        },
        {
            ...
            width: 140,
            ellipsis: true,
            render: (channel: string, record: ILead) => renderCopyableText(channel, record),
        },
        {
            key: "campaign",
            title: "Campanha",
            ...
            width: 180,
            ellipsis: true,
            render: (campaign: string, record: ILead) => renderCopyableText(campaign, record),
        },
        {
            key: "purchase_intent",
            ...
            width: 180,
            ellipsis: true,
            render: (purchaseIntent: string, record: ILead) => renderCopyableText(purchaseIntent, record),
        },
        {
            ...
            width: 180,
            ellipsis: true,
            render: (purchaseIntentPlanPrice: number | null, record: ILead) => renderCopyableText(purchaseIntentPlanPrice?.toString() ?? "-", record),
        },
        {
            key: "landing_page",
            title: "Landing page",
            ...
            width: 180,
            ellipsis: true,
            render: (landingPage: string, record: ILead) => {
                if (!landingPage) {
                    return (
                        <span
                            style={{
                ...
                return renderCopyableText(landingPage, record);
            },
        },
        {
            key: "cep",
            ...
            dataIndex: "cep",
            width: 120,
            render: (cep: string, record: ILead) => {
                if (!cep) {
                    return (
                        <span
                            style={{
                ...
                return renderCopyableText(cep, record);
            },
        },

        {
            ...
            dataIndex: "uf",
            width: 160,
            render: (_, record) => renderCopyableText(record.uf, record),
        }, {
            key: "city",
            title: "Cidade",
            dataIndex: "city",
            width: 160,
            render: (city: string, record: ILead) => renderCopyableText(city, record),
        },
        {
            key: "district",
            title: "Bairro",
            ...
            width: 160,
            ellipsis: true,
            render: (district: string, record: ILead) => renderCopyableText(district, record),
        },
        {
            key: "address",
            title: "Endereço",
            ...
            render: (_, record) => {
                ...
                return renderCopyableText(value, record);
            },
        },
        {
            key: "number",
            ...
            dataIndex: "number",
            width: 100,
            render: (numberValue: string, record: ILead) => {
                if (!numberValue) {
                    return (
                        <span
                            style={{
                ...
                return renderCopyableText(numberValue, record);
            },
        },
